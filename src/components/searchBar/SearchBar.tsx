        ...
        <>
            <div className='w-full mx-auto '>
                <div className="relative flex items-center w-full h-12    focus-within:shadow-lg y-500 overflow-hidden">
                    <div onClick={handleSearchText}  className="grid place-items-center bg-blue-700 cursor-pointer h-full w-12  text-white">
                    ...
                    <input
                        className="peer h-full w-full bg-blue-700  outline-none text-white text-lg"
                        type="text"
                        id="search"
